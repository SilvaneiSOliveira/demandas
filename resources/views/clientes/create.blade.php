    ...
    <div class="bg-white shadow-md rounded-lg p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div>
                        ...
                        <select name="estado" class="w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200" required>
                            ...
                            @foreach($ufs as $uf)
                                <option value="{{ $uf->uf }}" 
                                    @if(isset($cliente) && $cliente->estado == $uf->uf) selected @endif
        ...
        <div class="flex-1 min-w-[300px]">
            ...
            <div class="mb-8">
                ...
                <input type="text" name="contatos[0][nome]" placeholder="Nome" 
                   class="flex-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
            
            <select name="contatos[0][cargo]" class="flex-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
            ...
            <input type="text" name="contatos[0][telefone]" placeholder="Telefone" 
                   class="flex-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
            
            <input type="text" name="contatos[0][email]" placeholder="E-mail" 
                   class="flex-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
    ...
    <button type="button" id="adicionar-contato" class="mt-4 px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 transition">
        + Adicionar Contato
            ...
            <div class="flex justify-between mt-6">
                <a href="{{ route('clientes.index') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded hover:bg-gray-300">
                    ❌ Cancelar
                </a>
